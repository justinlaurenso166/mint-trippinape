...
//ubah disini
import mintingImage from '../assets/images/1.png'
    ...
    return (
        <div className="flex flex-col-reverse md:flex-row-reverse md:items-center md:gap-32 gap-10">
            <div className="mb-36 md:mb-0 mt-4 md:mt-4 flex-1">
                <h1 className="font-bold text-3xl md:text-7xl text-center md:text-center">
                    <span>Ape  <span className="text-blue-300"> Mint</span></span>
                </h1>
                <div className="w-full bg-white text-slate-800 mt-6 px-6 py-5 rounded-xl">
                    ...
                    <div className="flex justify-between mt-3">
                        <div className="flex items-center">
                            ...
                            <button
                                ...
                                className="px-1 text-xs font-semibold bg-blue-300 hover:bg-blue-400 transition-all duration-300 ease-in-out rounded-sm ml-2 text-semi-dark"
                            >
                                Max
                            </button>
                        </div>
                        <span className="space-x-4 flex items-center">
                            ...
                            >
                                <svg
                                    ...
                                    className="h-6 w-6 text-slate-800 hover:text-blue-300 transition-all duration-300 ease-in-out"
                                    viewBox="0 0 20 20"
                                    fill="currentColor"
                                >
                    ...
                    <div className="flex justify-between mt-3">
                        ...
                        <div className="flex items-center">
                            <span className="mr-1">
                                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-slate-800 fill-current">
                                    <title />
                    ...
                    <div className="flex justify-between mt-3">
                        ...
                        <div className="flex items-center">
                            ...
                            <a href={CONFIG.SCAN_LINK} target={'_blank'} className="text-2xl text-slate-800" rel="noreferrer">
                ...
                {claimingNft && (
                    <button className="mt-6 bg-blue-300 hover:bg-blue-400 transition-all duration-300 ease-in-out text-semi-dark font-semibold text-2xl w-full py-3 rounded-lg cursor-not-allowed">
                        Claiming NFT . . .
                    </button>
                )}
                {isWalletConnected() && isContractReady() && !isLoading() && !claimingNft ? (
                    <button
                        className="mt-6 bg-blue-300 hover:bg-blue-400 transition-all duration-300 ease-in-out text-semi-dark font-semibold text-2xl w-full py-3 rounded-lg"
                        onClick={(e) => {
                            e.preventDefault()
                            claimNFTs()
                            getData()
                    ...
                    <>
                        {isLoading() && !claimingNft ? (
                            ...
                            <>
                                {!claimingNft && (
                                    <button
                                        className="mt-6 bg-blue-300 hover:bg-blue-400 transition-all duration-300 ease-in-out text-semi-dark font-semibold w-full py-3 rounded-lg text-2xl"
                                        onClick={(e) => {
                                            e.preventDefault()
                                            dispatch(connect())
                                            getData()
            ...
            <img src={mintingImage} alt="Hero_Image" className="rounded-xl md:w-[50%] flex-1" />
